  ...
  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="leftCol" style="margin-top:7% ;">
           ...
           <li>
              <a href="subscriber.php" class="chart-nav"><i class="fa fa-user nav_icon"></i>Subscriber</a>
            </li>
        <li><a href="barbers.php" class="chart-nav"><i class="fa fa-user nav_icon"></i>Barber/Cutter</a>
		<li>
  <a href="barber-report.php"><i class="fa fa-file-text-o nav_icon"></i>Barber Sales Report</a>
</li>
            </li>
            <li>
